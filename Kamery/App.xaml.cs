...
public partial class App : Application
{
    ...
    public App()
    {
        ...
        ConfigureServices((context, services) =>
        {
            ...
            //services.AddTransient<PodrobnostiSeznamuPage>();
            services.AddTransient<DatováMřížkaViewModel>();
            services.AddTransient<DatováMřížkaPage>();
